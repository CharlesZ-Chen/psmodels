...
public:
  ...
  /*** TSS 28.5.2001 **/
  bool branch_merge_tested : 1;
  bool sometimes_true : 1;
  bool sometimes_false : 1;
...
public:
  ...
  virtual void print () {};
  /*** TSS 4.1.2001 **/
  virtual void print_internal (std::ostream &os = std::cout)  = 0;
  /*** TSS 4.1.2001 **/
...
public:
  ...
  void init (Init *);
  void print ();
  void print_internal (std::ostream &os = std::cout);
